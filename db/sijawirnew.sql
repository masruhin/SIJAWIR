...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2024 at 05:52 AM
...
CREATE TABLE `dokumen` (
  ...
  `id_jenis` tinyint(4) DEFAULT '0',
  `id_fakultas` int(25) DEFAULT '0',
  `id_prodi` int(25) DEFAULT '0',
...
INSERT INTO `dokumen` (`id_dok`, `id_univ`, `kd_dok`, `nm_dok`, `id_jenis`, `id_fakultas`, `id_prodi`, `thn_dok`, `ket_dok`) VALUES
(77, '1', 'DOK-080124-4', '2024-01-08_User Interface Jawir (1).pdf', 3, 0, 0, '2024-01-08', 'ses Rektor'),
(79, '0', 'DOK-080124-2', '2024-01-08_160-MASRUHIN (6).pdf', 3, 1, 5, '2024-01-08', 'ses admin');
...
--
ALTER TABLE `dokumen`
  MODIFY `id_dok` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
