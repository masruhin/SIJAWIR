 ...
 <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
   <div class="navbar-header">
     <ul class="nav navbar-nav flex-row">
       <li class="nav-item mr-auto"><a class="navbar-brand" href="beranda.php"><span class="brand-logo">
           ...
           <h2 class="brand-text"><?php if($_SESSION["level"]==1) {echo "Administrator";}?></h2>
         </a></li>
   ...
   <div class="main-menu-content">
     <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
       <li <?php if (isset($_GET["l"])){echo 'class="nav-item active"';}?>>
         <a class="d-flex align-items-center" href="beranda.php?l">
           <i data-feather="home"></i>
           <span data-i18n="Documentation"><strong>Home</strong></span>
         </a>
       </li>
       <li <?php if (isset($_GET["p"])){echo 'class="nav-item active"';}?>>
         <a class="d-flex align-items-center" href="upload.php?p">
